...
import org.dromara.project.config.GlobalMappingConfig;
...
public class ProjectExpenditureServiceImpl implements ProjectExpenditureService {
    ...
    private void processProjectExpenditureBO(ProjectExpenditureBO projectExpenditureBO,
        ...
        List<ProjectBalanceUnpaid> projectBalanceUnpaidListToInsert) throws ServiceException, IllegalAccessException {
        //获取经费字段
        String field =
